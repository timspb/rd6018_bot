...
- Компенсация пересчитывается на входе в этап и при восстановлении сессии, а при заметном изменении `temp_ext` может плавно подстроить напряжение в процессе заряда.
