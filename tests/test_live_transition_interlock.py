...
def live_state(**overrides):
    base = {
        ...
        "set_voltage": 14.72,
        "set_current": 7.20,
        "set_current_readback_v2": 7.20,
        "set_voltage_readback_v2": 14.72,
        "ovp": 14.82,
        "ocp": 7.30,
        "ovp_readback_v2": 14.82,
        "ocp_readback_v2": 7.30,
        "_meta": {
    ...
    for source, key in (
        ("set_voltage_readback_v2", "set_voltage"),
        ("set_current_readback_v2", "set_current"),
        ("ovp_readback_v2", "ovp"),
        ("ocp_readback_v2", "ocp"),
    ):
        if key in overrides:
