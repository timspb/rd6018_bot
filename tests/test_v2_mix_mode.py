...
class V2MixOnlyTests(unittest.IsolatedAsyncioTestCase):
    def test_auto_mix_exposes_existing_manual_v_i_delta_entry(self):
        ...
        self.assertNotIn("v2_manual", menu_callbacks)
        self.assertNotIn("v2_manual_choose", menu_callbacks)
        self.assertNotIn("v2_manual", preview_callbacks)
        self.assertNotIn("v2_manual_choose", preview_callbacks)
